...
var SampleValidator = (function () {
    ...
    function checkKeyIsDigit(event) {
        //console.log("madeittocheckkeyisdigit");
...
function checkCreditCardDate(cardMonth, cardYear, messages) {
     ...
     *
     * @return False, because server-side form handling is not implemented. Eve$
     */
    function validateCheckout() {
        //console.log("madeittovalidatecheckout");
        var messages, cardType, cardNumber, cardMonth, cardYear, cardValidation, errorHTML, deliveryEmail, deliveryName, deliveryAddress1, deliveryCity, deliveryPostcode;
 ...
 * Note that if the validation fails (returns false) then the form is not s$
 */
pub.setup = function () {
    /**
